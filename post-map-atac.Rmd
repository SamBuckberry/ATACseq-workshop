...
Make Tn5 insertion-centered bed files for peak calling
```{r}

# Make Tn5 insertions bigwig ----------------------------------------------

bam <- "aligned_data/1001-Effector_CD4pos_T-S_chr22_dedup.bam"
...
process_atac_bam <- function(bam){
    ...
    # Offset alignments to Tn5 insertion sites
    message("Offset alignments")
    ...
    gr_to_bed(gr = shift_gr, out_path = out_bed)
...
```{r}
"macs2 --gsize hs --nomodel --keep-dup all --name test -t aligned_data/1001-Effector_CD4pos_T-S_chr22_dedup_atac.bed"
```
